			...
			<div class="col s12 m12 l4" style="padding: 50px 5px;">
				<div class="card">
				    ...
				    <div class="card-content">
				      ...
				      <div class="card-content">
			          <p>North Indian dishes give an aroma of Mountains. They are the true bombing of flavors and spices in one go.</p>
			        </div>
				    </div>
			...
			<div class="col s12 m12 l4" style="padding: 50px 5px;">
				<div class="card">
				    ...
				    <div class="card-content">
				      ...
				      <div class="card-content">
			          <p>Indian Chinese food have set some benchmarks for the Chinese food. For a while, Chinese can forget their taste after tasting Indian Chinese.</p>
			        </div>
				    </div>
				    <div class="card-reveal">
			...
			<div class="col s12 m12 l4" style="padding: 50px 5px;">
				<div class="card">
				    ...
				    <div class="card-content">
				      ...
				      <div class="card-content">
			          <p>The real coconuty flavor is the speciality of South Indian food. Wanna taste the real South Indian cuisine?</p>
			        </div>
				    </div>
				    <div class="card-reveal">
