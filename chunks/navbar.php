<section class="fnavbar">
		...
		<nav>
		    <div class="nav-wrapper">
		      <a href="/RestroGirls" class="brand-logo">FoodShala</a>
		      ...
		      <ul class="right hide-on-med-and-down">
		        ...
		        <li><a href="foods.php" class="hvr-grow">Order</a></li>
				<li><a href="admin/index.php" class="hvr-grow">Admin Login</a></li>
		        <li><a href="#" class="hvr-grow" onclick="toggleModal('Contact Info', 'You can contact us directly by calling to this number +91-987123456. Check the bottom Footer Section of the website for more info.');">Contact</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
	        ...
	        <li><a href="foods.php">Order</a></li>
			<li><a href="admin/index.php">Admin Login</a></li>
	        <li><a href="#" onclick="toggleModal('Contact Info', 'You can contact us directly by calling to this number +91-987123456. Check the bottom Footer Section of the website for more info.');">Contact</a></li>
