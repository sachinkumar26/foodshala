<section class="fslider">
		<div class="slider">
		    ...
		    <li>
		        ...
		        <h3 style="font-size: 3rem !important; font-style: bold !important; font-family: 'Bree Serif', serif;">FoodShala - Hunger Mitao</h3>  
		        <h5 class="light black-text text-lighten-3"><strong>We serve quality. For best service - Try Us!</strong></h5>  
		      </div>  
		    </li>
